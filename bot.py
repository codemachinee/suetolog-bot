...
async def dr():
    ...
    if datetime.now().day == 6 and datetime.now().month == 3:
        await Artur_pozdravlyaet(bot, text=f'Поздравь с днем рождения Кирилла Подкастера с учетом следующих фактов о '
                                           ...
                                           f'8) Кирилл амбасадор лапши и главный критик цен в ресторанах.'
                                           f'9) Кирилл ненавидит страшные ёлки, и когда ему стелят на диване.'
                                           f'10) Ангел хранитель Кирилла - это Святая Лизка, но она '
                                           f'его бросила и ушла к додику,'
                                           f'поэтому он всегда ходит с разбитым носом' )
