...
async def dr():
    ...
    if datetime.now().day == 6 and datetime.now().month == 3:
        await Artur_pozdravlyaet(bot, text=f'Поздравь с днем рождения Кирилла Подкастера с учетом следующих фактов о '
                                           ...
                                           f'6) Мама Кирилла работает в медицине катастроф и в случае чего достанет '
                                           f'его с того света, поэтому он такой дерзкий со всеми. '
                                           f'Кирилл строит из себя циника касаемо амурных вопросов, горячо отстаивает '
                                           f'свои взгляды в спорах с парнями, но судьба увесистой пощечиной роняет его '
                                           f'в отношения. И только будущее покажет куда суждено попасть этой истории '
                                           f'на Netflix или на НТВ, ведь на кон поставлено все...')
        ...
        await Artur_pozdravlyaet(bot, text=f'Поздравь с днем рождения Илью с учетом следующих фактов о нем:'
                                           ...
                                           f'заведений города Орел. 2) Илюха каратист, оптимист и хороший друг. '
        ...
        await Artur_pozdravlyaet(bot, text=f'Поздравь с днем рождения Евгения Спасателя с учетом следующих фактов '
                                           f'о нем: 1) Женек учится на спасателя, обладает пышными волосами и формами, '
                                           f'а также большим опытом работы официантом и охранником. 2) Женек спит, '
                                           f'только когда за рулем и везет пацанов в город Орел, в остальное время он '
        ...
        await Artur_pozdravlyaet(bot, text=f'Поздравь с днем рождения Дмитрия с учетом следующих фактов о нем: '
                                           ...
                                           f'и кальянщиках. 3) Диман один из немногих в нашем чате кто уже стал отцом, '
                                           f'однако умнее и серьезнее он от этого не стал! '
        ...
        await Artur_pozdravlyaet(bot, text=f'Поздравь с днем рождения Александра, с учетом следующих фактов о нем: '
                                           ...
                                           f'3) Саня в душе брокер который нагнул мир, но зачем то пошел учиться на '
                                           f'военного и пока нагнул лишь только свои амбиции. '
                                           f'4) Саня стильный, думает что мощный. '
                                           f'5) Саня любит активный отдых, сноуборд, теннис, вейкборд и женщин. '
                                           f'6) Саня пытается использовать свободу по полному но она ограничена '
                                           f'отпуском')
        await bot.send_message(group_id, 'твой подарок - https://www.youtube.com/watch?v=N6nJpNIK4PU')
